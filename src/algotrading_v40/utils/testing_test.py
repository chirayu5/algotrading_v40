...
from algotrading_v40.utils.testing import expect_no_mutation
...
def test_expect_no_mutation_detects_mutation(label, obj, mutator, custom_equal):
  ...
  with pytest.raises(AssertionError):
    with expect_no_mutation(obj, **ctx_kwargs):
      mutator(obj)
